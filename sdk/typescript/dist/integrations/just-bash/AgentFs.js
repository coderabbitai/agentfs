        ...
        try {
            ...
            if (msg.includes("EISDIR")) {
                ...
                try {
                    ...
                    const rmdirMsg = rmdirErr instanceof Error ? rmdirErr.message : String(rmdirErr);
                    if (rmdirMsg.includes("ENOTEMPTY") ||
