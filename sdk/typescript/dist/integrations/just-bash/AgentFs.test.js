...
describe("AgentFsWrapper", () => {
    ...
    describe("constructor", () => {
        ...
        it("should throw for non-absolute mount point", () => {
            expect(() => new AgentFsWrapper({ fs: agentHandle, mountPoint: "relative" })).toThrow("Mount point must be an absolute path");
        });
    });
    describe("readFile", () => {
    ...
    describe("readFileBuffer", () => {
        ...
        it("should throw ENOENT for non-existent file", async () => {
            await expect(fs.readFileBuffer("/nonexistent.bin")).rejects.toThrow("ENOENT");
        });
    });
    describe("writeFile", () => {
    ...
    describe("symlink", () => {
        ...
        it("should throw EEXIST if path exists", async () => {
            await fs.writeFile("/file.txt", "content");
            await expect(fs.symlink("/target", "/file.txt")).rejects.toThrow("EEXIST");
        });
    ...
    describe("resolvePath", () => {
        ...
        it("should handle multiple .. in paths", () => {
            expect(fs.resolvePath("/a/b/c/d", "../../file.txt")).toBe("/a/b/file.txt");
        });
